...
template <typename T>
void BinaryTree<T>::printPaths(const Node* subRoot, std::vector<int> &path) const
{
  ...
  // Add the current node to the path
    ...
    // If this node is a leaf node, print the path
 ...
 * for writing your own private helper functions.
 * @param subRoot
 * @return The sum of Distances within the subtree.
 */
template <typename T>
