...
struct BinaryTree
{
  ...
  private:
     ...
     * Private helper function for the public height function.
     * @param subRoot The current node in the recursion.
     * @return The elements of a tree from left to right.
     */
     ...
     * Private helper function for the public height function.
     * @param subRoot The current node in the recursion.
     * @return mirrors the elements of a tree over a vertical axis.
     */
     ...
     * @return mirrors the elements of a tree over a vertical axis.
     */
    void printPaths(const Node* subRoot, std::vector<int> &path) const;
     ...
     * @return The height of the subtree.
     */
    int sumDistances(const Node* subRoot, int dist) const;
