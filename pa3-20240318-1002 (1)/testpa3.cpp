...
#define IMAGE_7 "kkkk-256x224-resized"
...
void TestPrune(double tol) {
	...
	// read input PNG
	PNG input;
	input.readFromFile("images-original/kkkk-256x224-resized.png");
	...
	// write output PNG
	string output_path = "images-output/kkkk-256x224-resized-prune_" + to_string(tol) + "-render.png";
	cout << "Writing rendered PNG to file... ";
	output.writeToFile(output_path);
	cout << "done." << endl;
